...
function ald_review_admin_notices($args){
	$args[] = array(
		'id' => "update-notice",
		'text' => "<b style='color:red;'>ATTENTION: </b>The scroll behaviour has fixed in this version. We've changed the <b>Load More button</b> structure what it was before the issue. Consider re-style the button. <br> <b style='color:#a9a9a9;'>If you just installed this plugin then ignore this notice.</b>",
		...
		'buttons' => array(
			array(
				'text' => "See Changelog for more details",
				'link' => "https://wordpress.org/plugins/ajax-load-more-anything/#developers",
				'target' => "_blank",
				'icon' => "dashicons dashicons-external",
				'class' => "button-secondery",
			),
			array(
				'text' => "See Support Panel",
				'link' => "https://wordpress.org/support/plugin/ajax-load-more-anything/",
				'target' => "_blank",
				'icon' => "dashicons dashicons-external",
				'class' => "button-secondery",
			),
