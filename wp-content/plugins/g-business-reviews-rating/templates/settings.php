...
<div id="google-business-reviews-rating-settings" class="wrap banner">
	<h1><span><?php esc_html_e('Reviews and Rating - Google Business', 'g-business-reviews-rating'); ?></span><?php echo ($this->demo) ? ' <span class="demo"><span class="dashicons dashicons-warning"></span> ' . __('Demo Mode', 'g-business-reviews-rating') . '</span>' : ''; ?></h1>
